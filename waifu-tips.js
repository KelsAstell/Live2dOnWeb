const live2d_settings = {
    ...
    // 模型设置
    'modelName': 'MC_Vtuber',                      // 默认加载的模型名称，仅在无本地记录的情况下有效
...
const live2d_models = [
    {
        name: 'MC_Vtuber',                                     // 模型名称要与文件夹名相同
        message: 'bilibili@大以巴狼艾斯 <a href="https://space.bilibili.com/103739">原作者Kiriyuki</a>',  // 切换时的提示信息
